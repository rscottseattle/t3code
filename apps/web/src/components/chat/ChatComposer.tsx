                      ...
                      .map((image) => {
                        ...
                        if (image.type === "file") {
                          return (
                            <div
                              key={image.id}
                              className="relative flex min-h-16 max-w-56 items-center gap-2 overflow-hidden rounded-lg border border-border/80 bg-background px-2.5 py-2 pr-8"
                              title={image.name}
                            >
                                  ...
                                  <TooltipTrigger
                                    render={
                                      <span
                                        ...
                                        className="absolute bottom-1 left-1 inline-flex items-center justify-center rounded bg-background/85 p-0.5 text-amber-600"
                                      >
                                  ...
                                  <TooltipTrigger
                                    render={
                                      <Button
                                        variant="ghost"
                                        size="icon-xs"
                                        className="absolute bottom-1 right-1 bg-background/85 hover:bg-background/95"
                                        onClick={() =>
                                          retryAttachmentUpload({ environmentId, image })
                                        }
