 ...
 * workspace paths, and diff/files/skills/agents remain singleton surfaces.
 */
...
// v12 preserves T3r's singleton Skills surface alongside upstream pull-request surfaces.
