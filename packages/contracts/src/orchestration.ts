...
/** Max size for non-image file attachments (markdown, CSV, text, HTML, etc.). */
...
/**
 * Non-image attachments dragged into the composer (markdown, CSV, HTML, plain
 * text, code, etc.). Providers receive these as inlined text context or as
 * native file parts when the harness supports it.
 */
